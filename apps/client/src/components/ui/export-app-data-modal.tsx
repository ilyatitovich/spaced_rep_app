...
import { exportAppData } from '@/services'

type ExportAppDataModalProps = {
  onClose: () => void
}

export default function ExportAppDataModal({
  onClose
}: ExportAppDataModalProps) {
  ...
  useEffect(() => {
    ...
    const handleExport = async () => {
      try {
        const { fileUrl, fileName } = await exportAppData()
  ...
  return (
    <>
      ...
      >
        <h2 className="text-xl font-bold text-center">Export All Data</h2>
