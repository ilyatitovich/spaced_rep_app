...
export default function SelectionModeFooter({
  ...
  return (
    <>
      <div
        ref={footerRef}
        className={`absolute bottom-0 left-0 right-0 z-50 w-full flex ${justifyContent} items-center gap-10 p-4 pb-2 bg-background transition-[opacity,translate] duration-300 ease-in-out ${
          isHidden
